...
WITH MonthlySales AS (
    ...
    FROM invoice.gstsaleitems gsi
    INNER JOIN invoice.gstSales gs ON gsi.gstSaleId = gs.id
    INNER JOIN invoice.gstItems gi ON gsi.itemId = gi.id
    WHERE
    gs.invoiceDate BETWEEN ${startDate}
    AND ${endDate}
    AND (
            ...
            JSON_OBJECT(
                ...
                c.placeOfSupply
                            ...
                            'items', (
                                ...
                                FROM invoice.gstsaleitems gsi2
                                INNER JOIN invoice.gstSales gs2 ON gsi2.gstSaleId = gs2.id
                                INNER JOIN invoice.GstItems i ON gsi2.itemId = i.id  -- ✅ Joining with GstItems to get item details
                                WHERE gsi2.gstSaleId = gs.id
