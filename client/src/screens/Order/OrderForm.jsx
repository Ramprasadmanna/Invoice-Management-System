        ...
        <form
            ...
            <div className='customer-note col-span-full'>
              <div className='flex items-center gap-2'>
                <input
                  ...
                  className='block cursor-pointer resize-none rounded-xs bg-slate-100 text-sm placeholder:text-slate-400 hover:border-slate-400 focus:border-slate-400 focus:ring-0'
                />
                <label
                  htmlFor='send-mail'
          ...
          <div className='flex items-center justify-end border-t border-slate-900/10'>
            <button
              ...
              {confirmOrderLoading ? 'Confirming Order ....' : 'Confirm Order'}
            </button>
          </div>
        </form>
      </div>
